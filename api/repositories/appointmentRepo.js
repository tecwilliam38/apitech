...
async function ListarAgenda(id_client, dt_start, dt_end, id_user) {
    ...
    // SELECT 
    //     pa.id_appointment, pa.id_user, us.description AS service,
    //     u.user_name AS tecnico, u.user_skill AS specialty, pa.booking_date,
    //     pa.booking_hour, usv.price AS preco, c.client_name AS cliente,
